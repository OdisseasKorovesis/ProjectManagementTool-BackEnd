...
public class BacklogController {
    ...
    public ResponseEntity<?> addProjectTaskToBacklog(@Valid @RequestBody ProjectTask projectTask, BindingResult result,
        ...
        ProjectTask projectTaskToBeSaved = projectTaskService.addProjectTask(backlogId, projectTask, principal.getName());
    ...
    public ResponseEntity<?> getProjectTask(@PathVariable String backlogId, @PathVariable String ptId, Principal principal) {
        ProjectTask projectTask = projectTaskService.findProjectTaskBySequence(backlogId, ptId, principal.getName());
